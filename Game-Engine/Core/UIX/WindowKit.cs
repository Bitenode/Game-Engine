...
namespace Game_Engine.Core.UIX
{
    ...
    public static class WindowKit
    {
        public static void Show(WindowSpec spec)
        {
            ...
            w.Background = new SolidColorBrush(Color.Parse("#2B2D31")); //  solid color – lighter than editor bg so menus stand out
        ...
        internal static class WindowChrome
        {
            ...
            private static Control BuildTitleBar(Window host, string titleText)
            {
                ...
                var g = new AGrid
                {
                    Background = new SolidColorBrush(Color.Parse("#313338")),
                    Height = TitleH
                };
